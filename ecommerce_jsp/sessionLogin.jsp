...
<a class="toplinks" title="Home" href="http://csci4xx.usc.edu:9007/mtpress/main.jsp"  STYLE = "text-decoration:none;">Home</a> &nbsp; &nbsp; &nbsp;| &nbsp;&nbsp; &nbsp;
 ...
 <a class="toplinks" title="Category" href="http://csci4xx.usc.edu:9007/mtpress/customerCatDisplay.jsp" STYLE = "text-decoration:none;">Category</a> &nbsp; &nbsp; &nbsp; |&nbsp;&nbsp; &nbsp;
  <a class="toplinks" title="Category" href="http://csci4xx.usc.edu:9007/mtpress/customerBookSearch.jsp" STYLE = "text-decoration:none;">Search</a> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
	</TD>
</TR>
</TABLE>
</div>
...
<!-- Sign in Column -->
  ...
  <form name= "login"  id = "login" action = "validateLogin.jsp"  method = "POST">
	...
	<TR>
		<TD id = "logincheck" colspan = "2" class ="col1"> <Font color = "red" >User Session expired. Please Sign in...</font> </TD>
		   </TR>
    <TR >
