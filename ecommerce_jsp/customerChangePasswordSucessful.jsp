...
<a class="toplinks" title="Home" href="http://csci4xx.usc.edu:9007/mtpress/main.jsp"  STYLE = "text-decoration:none;">Home</a> &nbsp; &nbsp; &nbsp;| &nbsp;&nbsp; &nbsp;
 ...
 <a class="toplinks" title="Category" href="http://csci4xx.usc.edu:9007/mtpress/bookDisplay.jsp" STYLE = "text-decoration:none;">Browse Books</a> &nbsp; &nbsp; &nbsp; |&nbsp;&nbsp; &nbsp;
...
<!-- Sign in Column -->
  ...
  <form name= "login"  id = "login" action = "validateLogin.jsp"  method = "POST">
	...
	<TR>
		<TD id = "logincheck" colspan = "2"> <Font style="font-size:14px;font-weight:bold;color:#2080C8">Password Changed Successfully. Please Sign in with New Password...</font> </TD>
		   </TR>
    <TR >
    ...
    <TR >
     ...
     <TR>
       ...
       <TR>
		<TD  style=" text-align: left;" colspan = "2"><SPAN style="font-size: 14px;">Not an existing Customer? &nbsp;<a href="http://cs-server.usc.edu:9007/mtpress/customerCreate.jsp" STYLE = "text-decoration:none;">Register a account</a>
              </SPAN></TD>
	 </TR>
