...
<TR>
	...
	<p>Terms Of USe </P>
	<ul>
<li> This Site can only used for Demo
<li> Please Do not enter your original credit card number
<li> The Session expired happens when the user befor has not properly logged out.
<li> Wait for a while and Then login
<li> Your Orders will reach in 7 days of confirm order payment.
<li> You cannot change the address once the order is confirmed	
	</ul>
