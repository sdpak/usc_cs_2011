...
<%
	...
	Connection C =DriverManager.getConnection("jdbc:mysql://cs-server.usc.edu:8511/hw2","root","deepak24");
            ...
            String sql="select FName, LName  from customer where username = '"+user+"'";
						...
						String sql6="select * from cart where username='" + user + "' order by productname";
...
<!------------------------------------------------------------JSP-------------------------------------------------------------->
			<TD style = "padding: 3mm 5mm 3mm 5mm "width = "60%">
             ...
             <div>
	          ...
	          <table   width = "60%" ><TR><TD>
		             ...
		             <form method="POST" action="customerCartUpdateProcess.jsp">
	<TABLE cellpadding = "2" width = "560" id="dataTable" >
		...
		<td style ="font-size:13px;padding:2mm 2mm 2mm 2mm;border:1px solid;">	<INPUT size = 4  type="text" name="bookquantity"	value="<%=rs6.getString("quantity")%>"/></td>
		<td style ="font-size:13px;padding:2mm 2mm 2mm 2mm;border:1px solid;">	<INPUT type="hidden" name="bookuser"	readonly value="<%=rs6.getString("username")%>"/></td>
		</tr>
	...
	<INPUT type="button" value="Clear Cart >" onclick="deleteallRows('dataTable')" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<INPUT type="Submit" value="Confirm Change >" /><BR/><BR/><SPAN style="font-size: 14px;FONT-WEIGHT:BOLD;color:366696;">The Changes Take effect only after Cliocking the Confirm Changes Button</span><BR/><BR/>

&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="http://csci4xx.usc.edu:9007/mtpress/customerCheckout.jsp" style="text-decoration:none"> <INPUT type="button" value="Proceed to Checkout >" /> </a>
	</form>
