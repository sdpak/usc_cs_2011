...
<!------------------------------------------------------------JSP-------------------------------------------------------------->
		...
		<?=form_open('customer/changePassword')?>
			...
			<TR>
				<TD width="120" style="font-size:15px"><?=form_label('Current Password', 'user_pass')?><Font color = "red" >* </font></TD>
				<TD><?=form_password('user_pass')?> <code>&nbsp;(6 to 8 of a-z,A-z,0-9)
                         </code></TD>
			</TR>
			
			  <TR>
	<TD colspan = 2 style="color:#FF2121;font-size:11px;">&nbsp;<?=form_error('user_pass')?></TD>
	 </TR>
	 
			<TR>
				<TD width="120" style="font-size:15px"><?=form_label('New Password', 'user_pass1')?><Font color = "red" >* </font></TD>
				<TD> <?=form_password('user_pass1')?><code>&nbsp;(6 to 8 of a-z,A-z,0-9)
				</code></TD>
			</TR>
			
						  <TR>
	<TD colspan = 2 style="color:#FF2121;font-size:11px;">&nbsp;<?=form_error('user_pass1')?></TD>
	 </TR>
			...
			<TR>
				...
				<TD><?=form_password('user_pass2')?>	</TD>
					<tr>	
								  ...
								  <TR>
	<TD colspan = 2 style="color:#FF2121;font-size:11px;">&nbsp;<?=form_error('user_pass2')?></TD>
	 </TR>
			...
			<TR>
				<TD  colspan = "2"><?=form_submit('changePassword', 'Update Password >')?></TD>
			</TR>
