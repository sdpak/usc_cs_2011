...
<!-- Category List -->
    ...
    <TR>
		<TD STYLE="FONT-WEIGHT:BOLD;FONT-SIZE:15px;text-align:center;background-color:D9F5C7;padding:1mm 2mm 1mm 2mm" height= "20">SELECT CATEGORY</TD>
	                      ...
	                      <form name= "categoryform" action = "http://csci4xx.usc.edu:9007/mtpress/customerCategoryDisplay.jsp" Method =POST>
						    <!--<TR>
    ...
    <TR>
		<TD STYLE="FONT-WEIGHT:BOLD;FONT-SIZE:15px;text-align:left;background-color:#D0D0D0;padding:1mm 2mm 1mm 2mm" height= "20" >BOOK CATEGORY: <%out.println(fetchCategory);%></TD>
    </TR>
	 ...
	 <TR>
		<TD style = "text-align:center;font-weight:bold;font-size:15px;color:B05235;">You Already added the book in Cart. Please change quantity by editing Cart</TD>
	 </TR>
...
<% 
						...
						<TR>
							...
							<TD style="text-align:center;"><input type="submit"  value="Add to Cart " onclick ="document.displaybook.bookid.value='<%=ProductId[y]%>';document.displaybook.bookname.value='<%=ProductName[y]%>' ;document.displaybook.bookprice.value='<%=ProductPrice[y]%>';document.displaybook.availability.value='<%=ProductAvailability[y]%>'" /></TD>
						</TR>
						<TR>
							<TD  width = "70%" style= "padding:1mm 3mm 1mm 3mm;">
