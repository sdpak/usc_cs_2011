...
<!------------------------------------------------------------JSP-------------------------------------------------------------->
			...
			<p style="font-weight:bold;font-size: 20px;"> Profile Information </p> 
              ...
              <TABLE cellpadding = 10 width = "500" cellpadding = "2">
				 <form name = "createform"method ="Post" >
						...
						<TR>
							<TD width="120" style="font-size:15px"><b>State</b> </font></TD>
							<TD><?php echo $row->state;?>
				         </TD>
						</TR>
						<TR>
							<TD width="120" style="font-size:15px"><b>City</b> </font></TD>
							<TD><?php echo $row->city;?>
				         </TD>
						</TR>
						<TR>
							<TD width="120" style="font-size:15px"><b>Zip</b> </font></TD>
							<TD><?php echo $row->zip;?>
				         </TD>
						</TR>
                         <TR>
