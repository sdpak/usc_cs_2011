...
<!-- Category List -->
    ...
    <TR>
	 ...
	 <input type="hidden" name = "availability" value  = "" />
	                        ...
	                        <TR>
									<TD style = "text-align:center;font-weight:bold;font-size:16px;color:2C7B11;">
									<br/>The Book You Selected is SUCCESSFULLY added to the cart.</TD>
	                         </TR>
							 
							 <TR>
									<TD style = "text-align:center;font-weight:bold;font-size:16px;color:B05235;">
									<br/><br/><br/>Please Select a Category from Available List of Categories and Click 'View Books 'to see the List of Books <br/><br/><br/><br/><br/></TD>
	                         </TR>
