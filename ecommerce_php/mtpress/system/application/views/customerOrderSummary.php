...
<!------------------------------------------------------------JSP-------------------------------------------------------------->
			<TD width = "20%">
			    ...
			    //$session_username = $this->session->userdata('session_username');
				$sql = "Select max(orderid)maxid from ordergen where username =?";
    			$fetchorderid = $this->db->query($sql, array($session_username)); 
				if($fetchorderid->num_rows() > 0):
				   foreach ($fetchorderid->result() as $roworderid):
				   $orderidfetched = $roworderid->maxid;
				?>
				
					
					<TR>
					<TD STYLE="FONT-WEIGHT:BOLD;FONT-SIZE:14px;text-align:left;background-color:#E7EEF9;padding:1mm 1mm 1mm 1mm">
						Order ID :<?php echo $roworderid->maxid; ?></TD>
					</TR>
...
<!-- Payment Info -->
			...
			<?php
			    ...
			    //$session_username = $this->session->userdata('session_username');
				$sql3 = "Select * from orderdetail where orderid = ?";
    			$orders = $this->db->query($sql3, array($orderidfetched)); 
			 ...
			 <?php
				...
				?>
						  ...
						  <Table width = "550" >
						  <Tr><TD><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  <a href="http://cs-server.usc.edu:4551/mtpress/index.php/customer/main" style="text-decoration:none;font-size:13;"> <INPUT type="button" value="Done >" style="font-size:13;"/> </a></TD></TR>
						  </Table>
